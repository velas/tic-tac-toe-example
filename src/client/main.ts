...
async function main() {
  program
    ...
    .argument(
      '[file_path]',
      "optional path to file with player's keypair used to sign transaction, or using default path from velas config file",
    )
  ...
  program
    ...
    .argument(
      '<second_player>',
      'base58 encoded pubkey of the opponent you decided to play with',
    )
    .argument(
      '[file_path]',
      "optional path to file with player's keypair used to sign transaction, or using default path from velas config file",
  ...
  program
    ...
    .argument(
      '<row>',
      '`x` coordinate, starting from top-left corner (0, 1 or 2)',
    )
    .argument(
      '<column>',
      '`y` coordinate, starting from top-left corner (0, 1 or 2)',
    )
    .argument(
      '[file_path]',
      "optional path to file with player's keypair used to sign transaction, or using default path from velas config file",
